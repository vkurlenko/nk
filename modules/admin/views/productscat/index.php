...
/* @var $searchModel app\Modules\admin\models\ProductscatSearch */
...
<div class="productscat-index">
    ...
    $columns = [
        ...
        [
            'attribute' => 'name',
            'value' => function($data){
                return Html::a($data->name, \yii\helpers\Url::to('/admin/productscat/update?id='.$data->id), ['target'=>'_blank']);
            },
            'format' => 'raw'
        ],
        [
            'attribute' => 'active',
            'value' => function($data){
                return \app\modules\admin\components\CheckboxWidget::widget(['data' => $data, 'attr' => 'active', 'model_name' => 'productscat']);
            },
            'format' => 'raw'
        ],
