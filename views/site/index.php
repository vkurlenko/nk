...
<section id="project-faces" class="section-center alignment-block">
    ...
    <a href="/">Все участники проекта &gt;</a>

    <div class="container-fluid">

        <div class="row">

            <div class="col-sm-6 col-xs-12 face align-left">
                <span>Марго</span>
                <a href="/web/site/person/">
                    <img src="/images/face1.jpg" width="350">
                </a>
            </div>
            <div class="col-sm-6 col-xs-12 face align-right">
                <span>Люсинэ</span>
                <a href="/">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 video align-left">
                ...
                <div class="yt-cover" data-src="BrQ17Yqbe70">
                ...
                <a href="/">Смотрите видео репортаж <i class="far fa-play-circle"></i></a>
            </div>
...
<section id="takepart" class="section-center">
    ...
    <button><span class="btn-title">Заполните анкету для кастинга</span><span>&#x2197;</span></button>
